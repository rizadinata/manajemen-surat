...
<html lang="en">
  <head>
    ...
    <title>PLTU | Manajemen Surat </title>
        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="index.html" class="site_title"><i class="fa fa-paw"></i> <span>Manajemen Surat</span></a>
            </div>
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-clone"></i>Master <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="<?= site_url('posisi'); ?>"> Posisi</a></li>
                      <li><a href="<?= site_url('jabatan'); ?>"> Jabatan</a></li>
                      <li><a href="<?= site_url('klasifikasi'); ?>"> Klasifikasi</a></li>
                      <li><a href="<?= site_url('sifat'); ?>"> Sifat Disposisi</a></li>
                      <li><a href="<?= site_url('instansi'); ?>"> Instansi</a></li>
                    </ul>
                  </li>

                  <li class="active"><a><i class="fa fa-users"></i> User <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="<?= site_url('role'); ?>"> Role</a></li>
                      <li><a href="<?= site_url('user'); ?>"> User</a></li>
                    </ul>
                  </li>
                  <li><a><i class="fa fa-edit"></i> Surat <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="<?= site_url('suratmasuk'); ?>"> Surat Masuk</a></li>
                  ...
                  <li><a><i class="fa fa-bar-chart-o"></i> Laporan <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="<?= site_url('posisi'); ?>"> Lap. S. Masuk</a></li>
                      <li><a href="<?= site_url('posisi'); ?>"> Lap. S. Keluar</a></li>
